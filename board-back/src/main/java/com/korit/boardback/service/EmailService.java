...
public class EmailService {
    ...
    private final String FROM_EMAIL = "child4564@gmail.com";
    ...
    public void sendAuthMail(String to, String username) throws MessagingException {
        ...
        final String SUBJECT = "[board_project] 계정 비활성화 인증 메일입니다.";
        String content = String.format("""
                ...
                <body>
                    <div style="display: flex; flex-direction: column; align-items: center; ">
                        <h1>계정 활성화</h1>
                        <p>계정 활성화를 하시려면 아래의 인증버튼을 클릭하세요.</p>
                        <a style="box-sizing: border-box; border: none; border-radius: 8px; padding: 7px 15px;
                        background-color: #2383e2; color: #ffffff;
                        text-decoration: none;" target="_blank" href="%s">인증하기</a>
                    </div>
                </body>
                </html>
                """, href);
    ...
    public String auth(String username, String token) {
        ...
        try {
            ...
            if (userRepository.findByUsername(username).isEmpty()) {
                responseMessage = "[인증실패] 존재하지 않는 사용자 입니다.";
            } else {
            ...
            responseMessage = "[인증실패] 토큰이 유효하지 않거나 인증시간을 초과하였습니다. ";
        }
